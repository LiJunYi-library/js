...
export const RNestedViewPage = defineComponent({
  ...
  setup(props, ctx) {
    ...
    function slideEnd(event) {
      ...
      console.log("scrollEl.value.scrollLeft ", scrollEl.value.scrollLeft);

      const from = scrollEl.value.scrollLeft;
      const index = Math.floor(from / scrollEl.value.offsetWidth);
      const roundIndex = Math.round(from / scrollEl.value.offsetWidth);
      ...
      const to = scrollEl.value.offsetWidth * adsIndex;
      adsorbAni = Animation({
        from: from,
        to: to,
        avg: 30,
      ...
      //     const to = scrollEl.value.offsetWidth * index;
      //     adsorbAni = Animation({
      //       from: from,
      //       to: to,
      //       avg: 20,
    ...
    onMounted(() => {
      extendedSlideEvents(scrollEl.value, {
        direction: ["left", "right"],
        customEventName: "swarp",
      });
      ...
      scrollEl.value.addEventListener("swarpRightEnd", slideRightEnd, {
        passive: false,
        capture: false,
      });
    });
    ...
    return () => {
      ...
      return (
        <div class="r-nested-view-page" ref={(el) => (scrollEl.value = el)}>
          <div
            class="r-nested-view-page-list"
