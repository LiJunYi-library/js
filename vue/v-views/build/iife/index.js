var rainbowElement = (function (exports, vue, rainbowElement, rainbowJs, vHooks) {
  'use strict';
  ...
  var script$2 = {
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        var _component_r_tab_item = vue.resolveComponent("r-tab-item");
        var _component_r_tabs = vue.resolveComponent("r-tabs");
        return vue.openBlock(), vue.createBlock(_component_r_tabs, vue.mergeProps({
          value: __props.listHook.value
        }, _objectSpread2({}, _ctx.$attrs)), {
          default: vue.withCtx(() => {
            var _props$listHook$list, _props$listHook;
            return [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList((_props$listHook$list = (_props$listHook = __props.listHook) === null || _props$listHook === void 0 ? void 0 : _props$listHook.list) !== null && _props$listHook$list !== void 0 ? _props$listHook$list : [], (item, index) => {
              var _props$listHook2, _props$listHook2$form;
              return vue.openBlock(), vue.createBlock(_component_r_tab_item, {
                ...
                class: vue.normalizeClass(["v-r-tab-item", 'v-r-tab-item' + index]),
                onClick: $event => {
                ...
                default: vue.withCtx(() => [vue.renderSlot(_ctx.$slots, "default", {
                  ...
                  return [vue.createTextVNode(vue.toDisplayString((_props$listHook4 = __props.listHook) === null || _props$listHook4 === void 0 || (_props$listHook4$form = _props$listHook4.formatterLabel) === null || _props$listHook4$form === void 0 ? void 0 : _props$listHook4$form.call(_props$listHook4, item, index)), 1 /* TEXT */)];
                })]),
                _: 2 /* DYNAMIC */
              }, 1032 /* PROPS, DYNAMIC_SLOTS */, ["trigger", "value", "class", "onClick"]);
            }), 128 /* KEYED_FRAGMENT */)), vue.renderSlot(_ctx.$slots, "active")];
          }),
          _: 3 /* FORWARDED */
        }, 16 /* FULL_PROPS */, ["value"]);
      };
  ...
  function useScrollController() {
    ...
    var RScrollContext = vue.inject("RScrollContext") || {};
    var controller = vue.reactive(_objectSpread2(_objectSpread2({
    ...
    function destroy() {
      rainbowJs.arrayRemove(RScrollContext === null || RScrollContext === void 0 ? void 0 : RScrollContext.children, controller);
    }
    vue.onBeforeUnmount(() => {
      destroy();
    });
  ...
  function useFallsLayout() {
    ...
    function getList() {
      return rainbowJs.arrayLoopMap(config.columns, i => ({
        height: 0,
        width: args.width,
        left: getLeft(i),
        top: 0,
  ...
  var VRPaginationLoading = vue.defineComponent({
    props: {
    ...
    setup(props, ctx) {
      ...
      function mounted() {
        ...
        scrollView = rainbowElement.findParentByLocalName(scrollName, vm.$el);
      ...
      function renderError() {
        return vue.renderSlot(ctx.slots, "error", {}, () => [vue.createVNode("div", {
        ...
        }, [vue.createTextVNode("\u51FA\u9519\u4E86 \u70B9\u51FB\u91CD\u65B0\u52A0\u8F7D")]), vue.createVNode("div", {
      ...
      function renderLoadError() {
        return vue.renderSlot(ctx.slots, "errorLoad", {}, () => [vue.createVNode("div", {
    ...
    setup(__props, _ref) {
      ...
      var list = vue.computed({
        ...
        get() {
          ...
          return vue.toRaw(props.modelValue);
        }
      });
      var refList = vue.computed(() => {
        if (props.listHook.list) return props.listHook.list;
      ...
      function onRenderItems(event) {
        ...
        vue.render(vue.createVNode(Item, {
          "event": event,
          "slots": slots,
      ...
      return (_ctx, _cache) => {
        var _component_r_scroll_virtual_grid_list = vue.resolveComponent("r-scroll-virtual-grid-list");
        return vue.openBlock(), vue.createBlock(_component_r_scroll_virtual_grid_list, {
  ...
  var script = {
    ...
    setup(__props, _ref) {
      ...
      return (_ctx, _cache) => {
        var _component_r_scroll_virtual_falls_list = vue.resolveComponent("r-scroll-virtual-falls-list");
        return vue.openBlock(), vue.createBlock(_component_r_scroll_virtual_falls_list, {
          modelValue: list.value,
          "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => list.value = $event),
          onrenderItems: onRenderItems,
          keyExtractor: props.keyExtractor
  ...
  var ListenerList$1 = vue.defineComponent({
    props: {
      list: Array
    },
    setup(props, context) {
      return () => {
        return vue.renderList(props.list || [], () => null);
      };
    }
  });
  var Item$1 = vue.defineComponent({
    ...
    setup(props, context) {
      var vm;
      vHooks.useResizeObserver(() => vm.$el, onSizeChange);
  ...
  var RScrollVirtualFallsListV2 = vue.defineComponent({
    props: _objectSpread2({}, mProps$2),
    setup(props, context) {
      var falls = useFallsLayout(props);
      var LIST = vue.computed(() => (props.listHook ? props.listHook.list : props.list) || []);
      var watchLock = false;
      var contentHtml;
      var INDEX = 0;
      ...
      var CURRENT = vue.reactive({
        nodeMap: new Map(),
        index: 0,
        list: []
      });
      var backstageTask = createBackstage();
      var mCtx = vue.reactive({
        context,
        slots: context.slots,
        renderItems,
        layout
      });
      vue.provide("RScrollVirtualFallsListContext", mCtx);
      context.expose(mCtx);
      vue.watch(() => LIST.value.slice(CURRENT.index, CURRENT.index + props.renderCount), onListChange);
      ...
      function renderItem(nth) {
        ...
        if (CACHE.nodeMap.has(ele)) {
          ...
          vue.render(vue.createVNode(Item$1, {
            "item": ele,
            "index": INDEX,
            "slots": context.slots,
      ...
      return () => {
        return vue.createVNode("div", null, [vue.createVNode(ListenerList$1, {
  ...
  var CONTEXT = vue.defineComponent({
    props: {
      list: Array
    },
    setup(props, context) {
      return () => {
        vue.renderList(props.list || [], (item, index) => null);
        return null;
      };
    }
  });
  var ListenerList = vue.defineComponent({
    props: {
      list: Array
    },
    setup(props, context) {
      return () => {
        return vue.createVNode(CONTEXT, {
          "list": props.list
        }, null);
      };
    }
  ...
  var RScrollVirtualFallsListV3 = vue.defineComponent({
    ...
    setup(props, context) {
      ...
      vue.provide("RScrollVirtualFallsListContext", mCtx);
      context.expose(mCtx);
      var onResizeDebounced = rainbowJs.animationDebounced(onResize);
      var onHeightChange = rainbowJs.animationDebounced(onChangeHeight);
      var scrollController = useScrollController({
        onScroll,
      ...
      vue.watch(() => LIST.value.slice(mCtx.index, mCtx.index + props.renderCount), () => {
        // console.log('list ------ watch', watchLock);
        if (watchLock) return;
        layout(true);
      });
      return () => {
        return vue.createVNode("div", null, [vue.createVNode(ListenerList, {
  ...
  var RScrollVirtualGridListItem = vue.defineComponent({
    props: {
      item: [Object, Array, String, Number],
      index: Number
    },
    setup(props, context) {
      var mCtx = vue.inject("RScrollVirtualGridListContext") || {};
      var html;
      ...
      return () => {
        return vue.createVNode("div", {
          "ref": el => html = el
        }, [vue.renderSlot(context.slots, "default", props)]);
      };
    }
  });
  var Context = vue.defineComponent({
    ...
    setup(props, context) {
      ...
      return () => {
        return vue.renderList(mCtx.renderList, (item, index) => {
          var _slot;
          handleMark(item);
          return vue.createVNode(RScrollVirtualGridListItem, {
          ...
          }, _isSlot(_slot = vue.renderSlot(mCtx.slots, "default", item)) ? _slot : {
            default: () => [_slot]
          });
          // return (
  ...
  var RScrollVirtualGridList = vue.defineComponent({
    props: _objectSpread2({}, mProps),
    ...
    setup(props, context) {
      ...
      var itemWidth = vue.computed(() => "calc( ".concat(100 / props.columns, "% - ").concat((props.columns - 1) * props.gap / props.columns, "px )"));
      var LIST = vue.computed(() => (props.listHook ? props.listHook.list : props.list) || []);
      var HEIGHT = vue.computed(() => {
        if (!LIST.value.length) return 0;
      ...
      vue.provide("RScrollVirtualGridListContext", mCtx);
      context.expose(mCtx);
      function getLeft(i) {
      ...
      function getRenderList(index) {
        ...
        rainbowJs.arrayLoop(props.columns, i => {
          if (index >= 0) {
  ...
  exports.RScrollVirtualFallsListV2 = RScrollVirtualFallsListV2;
  exports.RScrollVirtualFallsListV3 = RScrollVirtualFallsListV3;
  exports.RScrollVirtualGridList = RScrollVirtualGridList;
  exports.VRPaginationLoading = VRPaginationLoading;
  exports.VRTabs = VRTabs;
  exports.VRVirtualFallsList = VRVirtualFallsList;
  exports.VRVirtualGridList = VRVirtualGridList;

  return exports;

})({}, Vue, rainbowElement, rainbowJs, vHooks);
